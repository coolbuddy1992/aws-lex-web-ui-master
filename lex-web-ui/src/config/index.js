...
const configDefault = {
  ...
  lex: {
    // Lex bot name
    botName: 'WebUiHousejoyServices',

    // Lex bot alias/version
    botAlias: '$LATEST',

    // instruction message shown in the UI
    initialText: 'You can ask me for help housejoy services. ' +
      'Just type "housejoy services" or click on the mic and say it.',

    // instructions spoken when mic is clicked
    initialSpeechInstruction: 'Say "Housejoy Services" to get started',
  ...
  ui: {
    ...
    pageTitle: 'Housejoy Services Bot',
    ...
    // chat window title
    toolbarTitle: 'Housejoy Services',
