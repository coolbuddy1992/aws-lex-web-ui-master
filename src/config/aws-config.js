...
const aws_bots_config = '[{"name":"","alias":"$LATEST","description":"Bot to housejoy services.","bot-template":"bot-housejoy","commands-help":["I would like to pick up services","I would like to order some services","Housejoy services"],"region":"us-east-1"}]';
